...
const reserva = new Reserva(nombreIngresado, diasPaseos[diaSeleccionado - 1], horaPaseos[horaSeleccionada - 1], cantidaddeReservas, total);
console.log(reserva);
const reservas = [];
